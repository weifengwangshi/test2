...
import com.basefrm.excel.parsing.ExcelExport;
import com.basefrm.excel.parsing.ExcelHeader;
import com.basefrm.excel.parsing.ExcelImport;
import com.basefrm.excel.result.ExcelExportResult;
import com.basefrm.excel.result.ExcelImportResult;
import com.basefrm.excel.xml.XMLExcelDefinitionReader;
...
public class ExcelContext  {
	 ...
	 * @throws Exception
	 */
	public ExcelImportResult readExcel(String id, InputStream excelStream,String dr) throws Exception {
		return excelImport.readExcel(id,0, excelStream,null,false,dr);
	}
	 ...
	 * @throws Exception
	 */
	public ExcelImportResult readExcel(String id, InputStream excelStream,int sheetIndex,String dr) throws Exception {
		return excelImport.readExcel(id,0, excelStream,sheetIndex,false,dr);
	}
	 ...
	 * @throws Exception
	 */
	public ExcelImportResult readExcel(String id,int titleIndex, InputStream excelStream,String dr) throws Exception {
		return excelImport.readExcel(id,titleIndex, excelStream,null,false,dr);
	}
	 ...
	 * @throws Exception
	 */
	public ExcelImportResult readExcel(String id,int titleIndex, InputStream excelStream,boolean multivalidate,String dr) throws Exception {
		return excelImport.readExcel(id,titleIndex, excelStream,null,multivalidate,dr);
	}
	 ...
	 * @throws Exception
	 */
	public ExcelImportResult readExcel(String id,int titleIndex, InputStream excelStream,int sheetIndex,String dr) throws Exception {
		return excelImport.readExcel(id,titleIndex, excelStream,sheetIndex,false,dr);
	}
	 ...
	 * @throws Exception
	 */
	public ExcelImportResult readExcel(String id,int titleIndex, InputStream excelStream,int sheetIndex,boolean multivalidate,String dr) throws Exception {
		return excelImport.readExcel(id,titleIndex, excelStream,sheetIndex,multivalidate,dr);
	}
