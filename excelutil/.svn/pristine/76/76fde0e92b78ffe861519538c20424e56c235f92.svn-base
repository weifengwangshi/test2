...
! function (a) {
    ...
    a.extend(a.validator.messages, {
        ...
        maxlength: a.validator.format(icon + "最多 {0} 位数字"),
        minlength: a.validator.format(icon + "最少 {0} 位数字"),
        ...
        phone:icon + "请输入有效的手机号码",
        tel:icon + "请输入有效的座机或传真号码",
        IDcard:icon +"请输入有效的身份证号码",
        postcode:icon +"请输入有效的邮政编码"
    })
});
