    ...
    a.extend(a.validator, {
        ...
        methods: {
            ...
            creditcard: function(a, b) {
           	...
           	phone: function(a, b) {
                return this.optional(b) || /(^13[0-9]{9}$|14[0-9]{9}|15[0-9]{9}$|17[0-9]{9}$|18[0-9]{9}$)|(^(0\d{2,3})-?(\d{7,8})$)/.test(a);
            },
            tel: function(a, b) {
                return this.optional(b) || /^[0-9 \(\)]{7,30}$/.test(a);
            },
            IDcard: function(a, b) {
            	return this.optional(b) || /^(\d{17}[\d|x]|\d{15})$/.test(a);
            },
            postcode: function(a, b) {
            	return this.optional(b) || /^\d{6}$/.test(a);
            },
//            $.validator.addMethod("phoneOrtel", function(value, element) {
//			return this.optional(element) || /(^13[0-9]{9}$|14[0-9]{9}|15[0-9]{9}$|18[0-9]{9}$)|(^((0\d{2,3})-)(\d{7,8})$)/.test(value);
