$(function() {
	...
	function c() {
		...
		//为 tab栏重复，无法区别 添加 20170106 宋涛
		if(o.indexOf("CXTJ") < 0){
			if(o.indexOf("xqjyjg") > 0){
			l='学前'+l;
			}else if(o.indexOf("zxxjyjg") > 0){
				l='中小学'+l;
			}else if(o.indexOf("zzjyjg") > 0){
				l='中职'+l;
			}else if(o.indexOf("gdjyjg") > 0){
				if(o.indexOf("ZXXJGGL09") > 0){
					l='中小学'+l;	
				}else if(o.indexOf("ZZJGGL09") > 0){
					l='中职'+l;	
				}else if(o.indexOf("XQJGGL11") > 0){
					l='学前'+l;	
				}else{
					l='高校'+l;	
				}
			}else if(o.indexOf("mbjyjg") > 0){
				l='民办培训'+l;
			}
		}
